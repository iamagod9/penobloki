...
<html>
	...
	<body>
		...
		<div class="name_of_blocks_border">
			<h2 class="name_of_blocks">Контакты</h2>
		</div>
				...
				<div class="contact">
					<div class="contact-info">
						<div class="contact-item">
							...
							<p><span>Адрес</span>640101, г. Кемерово, ул. Студента 20</p>
						</div>

						<div class="contact-item">
							<i class="fa fa-phone"></i>
							<p><span>Телефон</span>+8 800 555 35 35</p>
						</div>

						<div class="contact-item">
							<i class="fa fa-envelope"></i>
							<p><span>E-Mail</span>idealnyi_dom@mail.ru</p>
						</div>
